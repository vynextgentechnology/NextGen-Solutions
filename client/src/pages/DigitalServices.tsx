  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-emerald-500/20">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 bg-gradient-to-br from-[#031c54] via-[#08368c] to-[#0e4cb8] text-white overflow-hidden">
        ...
        <div className="absolute -top-40 right-1/3 w-96 h-96 bg-blue-500/20 rounded-full blur-[130px]" />
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center max-w-3xl">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-tight mb-6">
              Tamil Nadu <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-sky-200 to-white">e-Sevai & Digital</span> Services
            </h1>
            ...
            <div className="mb-8 text-center flex justify-center overflow-hidden">
              <p className="text-sm sm:text-base md:text-lg text-blue-100 font-semibold px-4 max-w-3xl leading-normal sm:whitespace-nowrap">
                <HeroTypewriter text="Fast online processing for Tamil Nadu revenue certificates, smart ration cards, and welfare schemes." />
              </p>
            </div>
